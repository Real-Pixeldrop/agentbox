...
const fr: Translations = {
  ...
  skills: {
    ...
    emailManagement: "Gestion des emails",
    emailManagementDesc: "Lire, classer et répondre aux emails automatiquement.",
    calendar: "Calendrier",
    ...
    socialMedia: "Réseaux Sociaux",
    socialMediaDesc: "Poster sur LinkedIn, Instagram et gérer l'engagement social.",
    seoAudit: "Audit SEO",
    seoAuditDesc: "Analyser le SEO d'un site web et suggérer des améliorations.",
    newsletter: "Newsletter",
    newsletterDesc: "Créer et envoyer des newsletters professionnelles.",
    voiceAssistant: "Assistant Vocal",
    voiceAssistantDesc: "Convertir le texte en parole et assistance vocale.",
    fileManager: "Gestionnaire de fichiers",
    fileManagerDesc: "Organiser, rechercher et gérer des fichiers et documents.",
    codeAssistant: "Assistant de Code",
    codeAssistantDesc: "Aide au développement, révision de code et débogage.",
    dataAnalysis: "Analyse de données",
    dataAnalysisDesc: "Analyser des données et générer des rapports insights.",
    // UI
  ...
  settingsPanel: {
    ...
    deleteAgent: "Supprimer cet agent",
    deleteAgentTitle: "Supprimer l'agent",
    deleteAgentWarning: "Cette action est définitive",
    deleteAgentConfirmText: "Êtes-vous sûr de vouloir supprimer {agentName} ? Toutes ses données, conversations et paramètres seront définitivement perdus.",
    deleteAgentConfirm: "Oui, supprimer l'agent",
