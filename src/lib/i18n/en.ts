const en = {
  ...
  skills: {
    ...
    emailManagement: "Email Management",
    emailManagementDesc: "Read, organize and respond to emails automatically.",
    calendar: "Calendar",
    ...
    socialMedia: "Social Media",
    socialMediaDesc: "Post on LinkedIn, Instagram and manage social engagement.",
    seoAudit: "SEO Audit",
    seoAuditDesc: "Analyze website SEO and suggest improvements.",
    newsletter: "Newsletter",
    newsletterDesc: "Create and send professional newsletters.",
    voiceAssistant: "Voice Assistant",
    voiceAssistantDesc: "Text-to-speech conversion and voice assistance.",
    fileManager: "File Manager",
    fileManagerDesc: "Organize, search and manage files and documents.",
    codeAssistant: "Code Assistant",
    codeAssistantDesc: "Development help, code review and debugging.",
    dataAnalysis: "Data Analysis",
    dataAnalysisDesc: "Analyze data and generate insight reports.",
    // UI
  ...
  settingsPanel: {
    ...
    deleteAgentWarning: "This action is permanent",
    deleteAgentConfirmText: "Are you sure you want to delete {agentName}? All its data, conversations and settings will be permanently lost.",
    deleteAgentConfirm: "Yes, delete agent",
    deleting: "Deleting...",
